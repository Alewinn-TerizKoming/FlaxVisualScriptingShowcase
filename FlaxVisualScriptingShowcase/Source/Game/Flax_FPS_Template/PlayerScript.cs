...
public class PlayerScript : Script
{
    ...
    /// <summary>
    /// Apply the camera orientation to CamAlignedObject (aka "player avatar")
    /// </summary>
    private void ApplyPlayerRotation()
    {
        if (CamAlignedObject == null) return;
        ...
        if (cameraForward.LengthSquared > Mathf.Epsilon)
        {
            ...
            CamAlignedObject.Orientation = targetRotation;
        }
    }
